...
<script type="text/javascript">
	$(function () {
		$("#productTypeEditForm").find("[regr]").keyup(function () {
			//获得value
			var valStr = $(this).val();
			//获得正则表达式
	...
	function validForm() {
		var isSubmit=true;
		$("#productTypeEditForm").find("[regr]").each(function () {
			//获得value
			var valStr = $(this).val();
			//获得正则表达式
		 var regrStr=$(this).attr("regr");
		...
		function submitPTypeForm() {
			...
			if (isOk) {
				if (isReapeate == 'yes') {
					$("#productTypeEditForm").ajaxSubmit({
						async: false,
						dataType: "text",
						success: function (responseText) {
...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">商品类别管理--商品类别修改</span>
		</div>
	</div>
	<div class="content-text">
		<div class="square-order">
			<form action="${path}/ajax_productType_edit.action" method="post" id="productTypeEditForm">
				<input type="hidden" name="pType.productTypeId" value="<s:property value="pType.productTypeId"/>">
