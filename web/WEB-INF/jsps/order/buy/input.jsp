...
<div class="content-right">
	...
	<div class="content-text">
		<form action="${path}/ajax_orderModel_submitOrder.action" method="post" id="orderInputForm">
			<div class="square-o-top">
				...
				<tr>
					...
					<td width="648px">
						<s:select id="supplierId" list="#sList" listKey="supplierId" listValue="name" name="query.supplierId" cssClass="kuan" style="width:300px" headerKey="" headerValue="--请选择--"></s:select>
			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="center" bgcolor="#FFFFFF" id="defaultTr">
						...
						<td class="total" align="right" trTotal="">&nbsp;元</td>
						<td>
