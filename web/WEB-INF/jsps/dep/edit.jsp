...
<script type="text/javascript">
	$(function() {
		$("#depEditForm").find("[regr]").keyup(function () {
			//获得正则表达式
	...
	function validDepForm() {
		...
		//通过属性选择器拿到需要校验的项
		$("#depEditForm").find("[regr]").each(function () {
			//获得正则表达式
		var regStr=$(this).attr("regr");
		//将正则表达式转换成正则表达式对象
			var reg=new RegExp(regStr);
	...
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">部门管理--部门修改</span>
		</div>
	</div>
	<div class="content-text">
		<div class="square-order">
			<form action="${path}/ajax_dep_editDep.action" method="post" id="depEditForm">
				<%--设置depId的隐藏域--%>
