...
<script type="text/javascript">
	$(function() {
		$("#roleInputForm").find("[regr]").keyup(function () {
			//获得表单内容
			var valStr=$(this).val();
			//获得正则表达式
	...
	function validRoleForm() {
		var isOk=true;
		$("#roleInputForm").find("[regr]").each(function () {
			//获得表单内容
			var valStr=$(this).val();
			//获得正则表达式
			var regr=$(this).attr("regr");
	...
	//通过ajax方式提交表单
	function submiRoleInputForm() {
		var isOk=validRoleForm();
		//设置正确的标志result
		var result="";
		if (isOk) {
			$("#roleInputForm").ajaxSubmit({
				async:false,
				dataType:"text",
...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">角色管理--角色添加</span>
		</div>
	</div>
	<div class="content-text">
		<div class="square-order">
			<form action="${path}/ajax_role_addRole.action" method="post" id="roleInputForm">
