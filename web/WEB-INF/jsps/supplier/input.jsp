...
<script type="text/javascript">
	$(function () {
		$("#supplierInputForm").find("[regr]").keyup(function () {
			var valStr=$(this).val();
	...
	function validSupplierForm() {
		var isSubmit=true;
		$("#supplierInputForm").find("[regr]").each(function () {
			var valStr=$(this).val();
			var regr=$(this).attr("regr");
			var reg=new RegExp(regr);
			var tipStr=$(this).attr("tip");
...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">供应商管理--供应商添加</span>
		</div>
	</div>
	<div class="content-text">
		<div class="square-order">
			<form action="${path}/ajax_supplier_addSupplier.action" method="post" id="supplierInputForm">
